<template>
  <div class="user-menu" v-if="user">
    ...
    <el-popover :class="$style.userMenuPopover" trigger="click" virtual-triggering :virtual-ref="menuButtonRef"
      width="fit-content" transition="none" :offset="8" :hide-after="0" :show-arrow="false">
