...
class AuthorizedAxiosHttpClient extends HttpClient {
  ...
  constructor(axios) {
    ...
    this.axios.interceptors.request.use((config) => {
      ...
      if (accessToken) {
        config.headers['Authorization'] = `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI5OTQ1NGM4OS1jZTYwLTQ3ZDEtYTUzYS02MDRjMjQwYmI2MzkiLCJpYXQiOjE3MzcwNDIxNjgsImV4cCI6MTczNzA0NTc2OH0.QmcTDS2Dh5_b9GCb-UVSgsaWMnFiKjJISn-vqqI-wRQ`
      }
