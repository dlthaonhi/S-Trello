...
projectRouter.get("/",authenticateJWT,ProjectController.getAllProjects )
...
projectRouter.post("/:projectId/board/:templateId",canAccessBy("project","member", "admin"),ProjectController.createBoardByTemplateId);
