...
import { CardController, realtimeCardEvent } from "./card.controller";
...
cardRouter.post("/:cardId/comment",authenticateJWT, CardController.createComment);

cardRouter.get('/events', realtimeCardEvent);
// cardRouter.post('/update-status', CardController.updateCard);
